    ...
    "autotask": {
        ...
        "setup": {
            ...
            "steps": [
                ...
                "<strong>Custom (Internal Integration)</strong>, give it an "
                "internal name (e.g. \"Thread Ticket Report\"), and save — "
                "the actual tracking identifier value is generated "
                "automatically, not something you type in yourself.",
            ],
            "result_note": (
                "You'll end up with three values: Username, Secret, and "
                "API Integration Code — all three are auto-generated by "
                "Autotask, not values you choose."
            ),
        },
        "fields": [
            {
            ...
            },
            {
                ...
                "secret": False,
                "help": "Auto-generated by Autotask once you select \"Custom "
                        "(Internal Integration)\" on the API user's Security "
                        "pane — not something you type in yourself.",
            },
        ],
    },
    "halo": {
